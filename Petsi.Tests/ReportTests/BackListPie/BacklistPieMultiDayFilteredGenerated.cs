...
namespace Petsi.Tests.ReportTests.BackListPie
{
    ...
    public class BacklistPieMultiDayFilteredGenerated : IDisposable
    {
        ...
        public BacklistPieMultiDayFilteredGenerated(ITestOutputHelper helper)
        {
            this.helper = helper;
        ...
        [Fact]
        public void BacklistPieMultiDay_FilterSquare_Generated()
        {
        ...
        [Fact]
        public void BacklistPieMultiDay_FilterWholesale_Generated()
        {
            //For Start 10/1/2024 - 10/8/2024, Sunday (1st and 8th overlap, so SUNDAY will occur twice, so a total of 36 items
            DateTime start = DateTime.Parse("10/1/2024");
            DateTime end = DateTime.Parse("10/8/2024");
        ...
        [Fact]
        public void BacklistPieMultiDay_FilterSpecial_Generated()
        {
            //For Start 10/1/2024 - 10/8/2024, Sunday (1st and 8th overlap, so SUNDAY will occur twice, so a total of 36 items
            DateTime start = DateTime.Parse("10/1/2024");
            DateTime end = DateTime.Parse("10/8/2024");
